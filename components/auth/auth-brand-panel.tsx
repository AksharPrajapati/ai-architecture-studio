  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col justify-center py-10 xl:py-14">
        <h1 className="max-w-lg font-sans text-3xl font-semibold leading-tight tracking-tight text-white lg:text-4xl xl:text-5xl 2xl:text-6xl">
          Design systems at the speed of thought.
        </h1>
        <p className="mt-4 max-w-lg text-sm leading-relaxed text-white/75 lg:text-base xl:mt-6 xl:text-lg">
